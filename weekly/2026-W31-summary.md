...
本周监测到一项新的Starlink任务条目（SL-17-52），其余历史条目未发生语义变化。

### 来源约束要点

| 要点 | 来源记录 | 来源链接 | 限制说明 |
|---|---|---|---|
| SpaceX官方任务页面显示，计划使用猎鹰9号火箭从范登堡太空军基地发射24颗Starlink卫星。 | 5bbf6ea4ad2f7fd0 | https://www.spacex.com/launches/sl-17-52 | 发射时间未公布，任务状态为"targeting"。 |
| 现有官方条目介绍Starlink V3卫星的下一代设计，具有更高的容量和数据密度。 | ba5555615b6e6fb6 | https://starlink.com/updates/starlink-version-3-satellites |  |
| 现有官方记录显示Space Safety Web Interface可用于简化卫星交会筛查和星历共享。 | 044bafcf1089533d | https://starlink.com/updates/space-safety-web-interface |  |
| 现有官方网络更新提到Starlink已扩展至42个新国家，活跃客户超过600万，美国峰值中位下载速度约200 Mbps（2025年7月）。 | d3b89bb9510b1b9a | https://starlink.com/updates/network-update | 数据反映截至2025年7月的情况。 |
| 现有官方条目说明Starlink通过波束切换自动绕开障碍物，保障可靠高速互联网连接。 | 495a49c7d5c93cbc | https://starlink.com/updates/starlink-beam-switching |  |
| 现有官方记录介绍Stargaze是SpaceX开发的新型空间态势感知（SSA）系统。 | 95bbf31b3a93d3e6 | https://starlink.com/updates/stargaze |  |
...
|---|---|---|---|---|---|---|
| Starlink Mission | SpaceX Official Launches | 未知 | new | item_level | medium | [链接](https://www.spacex.com/launches/sl-17-52) |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| SpaceX Official Launches | 1 | 1 | 0 | 0 | 2 | 0 | 0 | 0 | 0 |
| Starlink Official Updates | 5 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |

### 本轮新增条目

- [5bbf6ea4ad2f7fd0](https://www.spacex.com/launches/sl-17-52)：本轮首次发现，不自动等于官方本周首次发布。
...
- [05610f007056730c](https://www.spacex.com/launches/sl-17-39)：temporarily_missing。
